...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'index.hero_title_line1': '永恒',
    'index.hero_title_line2': '浪漫',
    'index.hero_descriptor': '为重视质感与纪念意义的用户，生成可分享、可打印的高品质婚纱影像。',
    ...
    'index.portal_label': '高阶定制',
    'index.portal_title': 'AI 设计中心',
    'index.portal_desc': '上传参考图与灵感描述，快速搭建你的专属婚纱风格。',
    ...
    'orders.title': '我的作品',
    'orders.subtitle': '查看生成进度、预览结果与高清交付记录。',
    'orders.loading': '正在加载…',
    'orders.empty': '暂时还没有作品',
    'orders.start': '开始创作',
    'orders.custom': '自由定制',
    'orders.signin_required': '登录后查看作品',
    'orders.signin_required_subtitle': '登录账号后，系统会同步展示你的生成进度、预览图和高清交付记录。',
    'orders.signin': '登录 / 注册',
    'orders.load_failed': '订单加载失败',
    'orders.retry': '重新加载',
    'orders.view': '查看结果',
  ...
  en: {
    ...
    'index.hero_title_line1': 'Eternal',
    'index.hero_title_line2': 'Romance',
    'index.hero_descriptor': 'Boutique AI wedding portraits designed for keepsake-quality memories.',
    ...
    'index.portal_desc': 'Upload references and shape your own wedding aesthetic with scene and outfit direction.',
    ...
    'index.feature_desc': 'High-fidelity generation tuned for social sharing and print.',
    'index.footer_logo': 'AI Wedding',
    ...
    'orders.signin_required_subtitle': 'After signing in, your generation progress, previews, and final deliveries are kept in one gallery.',
    'orders.signin': 'Sign in / Register',
