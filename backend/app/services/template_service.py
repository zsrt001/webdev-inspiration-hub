...
def _build_templates() -> list[Template]:
    ...
    templates.extend(
        _portrait_pair(
            ...
            single_image_url="/style-previews/chn_xiuhe.jpg",
    ...
    templates.extend(
        _portrait_pair(
            ...
            single_background_prompt="strictly indoor castle-inspired bridal studio set with carved stone arches, painted warm architectural backdrop, polished floor, controlled studio lighting, no mountain vista, no open sky, no outdoor balcony, no terrace overlook, no exterior travel scene",
            couple_id="royal_castle",
            couple_title="Royal Castle",
            couple_image_url="/style-previews/royal_castle.jpg",
            ...
            couple_background_prompt="strictly indoor castle-inspired bridal studio set with carved stone arches, painted warm architectural backdrop, polished floor, controlled studio lighting, no mountain vista, no open sky, no outdoor balcony, no terrace overlook, no exterior travel scene",
            single_prompt_blocks={
                "composition": "full-length bridal portrait with complete couture gown and train visible, upright 3:4 framing, refined headroom, no overfilled crop, camera-readable near-frontal or soft three-quarter face, both eyes or both eye corners visible; full side profile is not acceptable for this main deliverable",
                ...
                "style": "high-end bridal studio portrait rather than outdoor snapshot; serene warm bridal expression with eyes emotionally engaged, no detached fashion-profile stare",
            },
            couple_prompt_blocks={
                "composition": "full-length couple portrait with both outfits complete and readable, upright 3:4 framing, balanced spacing, no overfilled crop, both faces camera-readable near-frontal or soft three-quarter, no full side profile hiding one partner's expression",
                ...
                "texture": "luxury embroidered fabric detail, natural skin texture, clean retouch without plastic smoothing",
                "style": "high-end bridal studio portrait rather than outdoor snapshot; relaxed connected couple expression, both partners emotionally present, eyes and mouths smiling together",
            },
        )
    )
    templates.extend(
    ...
    templates.extend(
        _portrait_pair(
            ...
            couple_image_url="/style-previews/couple_hk_retro.jpg",
    ...
    templates.extend(
        _portrait_pair(
            ...
            couple_image_url="/style-previews/couple_cyberpunk_city.jpg",
