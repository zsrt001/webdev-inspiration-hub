...
def _build_templates() -> list[Template]:
    ...
    templates.extend(
        _portrait_pair(
            ...
            single_background_prompt="castle-inspired indoor bridal studio set with carved stone arches, painted mountain backdrop, polished floor, controlled studio lighting",
            ...
            couple_background_prompt="castle-inspired indoor bridal studio set with carved stone arches, painted mountain backdrop, polished floor, controlled studio lighting",
