...
_SPECIFIC_LIGHTING_TEXT_PATTERNS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        ...
        (
            ...
            r"\barchitecture (?:is |looks |appears )?(?:unreadable|smeared|mushy|melted)\b",
            r"\b(?:arches|columns|windows|drapery|flowers|garden|floor lines?) (?:are |is |look |looks |appear |appears )?(?:unreadable|smeared|mushy|melted|erased)\b",
            r"\bvenue (?:texture|materials?|details?) (?:are |is |look |looks |appear |appears )?(?:erased|smeared|unreadable|mushy)\b",
            r"\bpremium location (?:is |looks |appears )?(?:erased|unreadable|smeared|mushy)\b",
        ),
    ),
)
...
QA_REASON_SYNONYMS: dict[str, str] = {
    ...
    "advertising_grin": "unnatural_expression",
    "catalog_smile": "unnatural_expression",
    "mouth_only_smile": "unnatural_expression",
    "eyes_not_smiling": "unnatural_expression",
    "smile_eye_mismatch": "unnatural_expression",
    "cold_expression": "unnatural_expression",
    ...
    "unreadable_venue": "background_over_blurred",
    "unreadable_architecture": "background_over_blurred",
    "mushy_flowers": "background_over_blurred",
    "erased_floor_lines": "background_over_blurred",
    "erased_venue_detail": "background_over_blurred",
...
QA_REASON_DETAILS: dict[str, dict[str, str | bool]] = {
    ...
    "face_distortion": {
        ...
        "repair_stage": "targeted_repair",
        "repair_hint": "Repair distorted facial geometry using the original face references as the authority; restore the source nose bridge, nose tip, nostrils, mouth, jawline, and side-profile proportions.",
    },
    "fused_faces": {
        "category": "face",
    ...
    "unexpected_extra_subject": {
        ...
        "severity": "critical",
        "blocking": True,
        "repair_action": "remove_unrequested_extra_subject",
        "repair_stage": "targeted_repair",
        "repair_hint": "Remove every unrequested extra person, second face, partner, guest, or duplicate body; preserve exactly the requested subject count and identity references.",
    },
    "identity_swap": {
        "category": "identity",
        "target": "role_order",
    ...
    "identity_mismatch": {
        ...
        "repair_stage": "targeted_repair",
        "repair_hint": "Regenerate or repair from the original identity references; do not keep the wrong generated face. Preserve the source face shape, nose size, nose bridge and tip, nostrils, mouth, jawline, chin, and side-profile silhouette.",
    },
    "identity_similarity_low": {
        "category": "identity",
    ...
    "unnatural_expression": {
        "category": "face",
        "target": "expression_authenticity",
        "severity": "major",
        "blocking": True,
        "repair_action": "restore_natural_wedding_expression",
        "repair_stage": "targeted_repair",
        "repair_hint": "Restore a natural, emotionally believable wedding expression from the identity references; use a camera-readable near-frontal or soft three-quarter face with both eyes or eye corners visible, make eyes and mouth agree, and avoid waxy smiles, frozen faces, mannequin looks, cold fashion profiles, full side profiles, or beauty-filter masks.",
    },
    "unnatural_gaze": {
        "category": "face",
        "target": "eye_gaze_and_liveliness",
        "severity": "major",
        "blocking": True,
        "repair_action": "repair_eye_gaze_and_catchlights",
        "repair_stage": "targeted_repair",
        "repair_hint": "Repair eye alignment, gaze direction, eyelids, iris detail, and natural catchlights while preserving the source identity and expression family.",
    },
    "face_underexposed": {
        "category": "photography_quality",
    ...
    "background_over_blurred": {
        ...
        "repair_stage": "final_polish",
        "repair_hint": "Keep natural depth of field but restore commercially readable architecture, studio-set, garden, floor, window, flower, or drapery detail so the venue remains premium and recognizable while staying softer than the faces.",
    },
    "flat_centered_pose": {
        "category": "composition",
