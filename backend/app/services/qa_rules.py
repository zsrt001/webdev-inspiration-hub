...
QA_REASON_DETAILS: dict[str, dict[str, str | bool]] = {
    ...
    "unnatural_expression": {
        ...
        "repair_stage": "targeted_repair",
        "repair_hint": "Restore a natural, emotionally believable wedding expression from the identity references; avoid waxy smiles, frozen faces, mannequin looks, or beauty-filter masks.",
    },
    "unnatural_gaze": {
        "category": "face",
