...
QA_REASON_DETAILS: dict[str, dict[str, str | bool]] = {
    ...
    "unnatural_expression": {
        ...
        "repair_stage": "targeted_repair",
        "repair_hint": "Restore a natural, emotionally believable wedding expression from the identity references; prefer near-frontal or three-quarter warmth, make eyes and mouth agree, and avoid waxy smiles, frozen faces, mannequin looks, cold fashion profiles, or beauty-filter masks.",
    },
    "unnatural_gaze": {
        "category": "face",
