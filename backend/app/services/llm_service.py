...
async def verify_generated_image_quality(
    ...
    *,
    ...
    prompt = (
        ...
        "- Compare against the source portrait's useful composition when available. If the source has a complete gown/body layout and the generated result regresses into a tighter head/torso crop, excessive headroom, or missing lower gown/train, passed=false with dress_cropped, awkward_crop, excessive_headroom, or background_dominates as appropriate.\n"
