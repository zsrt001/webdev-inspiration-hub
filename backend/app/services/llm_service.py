...
async def verify_generated_image_quality(
    ...
    *,
    ...
    prompt = (
        ...
        "- Main delivery layout is strict: unless the user explicitly requested a close-up, the result must not be a headshot, bust portrait, half-body portrait, waist-up crop, square crop, landscape banner, or an image dominated by empty sky/ceiling/blank space. A polished face close-up is still a paid-product failure if the full wedding wardrobe, gown hem/train, shoes or bottom room are missing.\n"
