...
async def run_order_generation(order_id: str) -> None:
    ...
    await generation_service.generate_photo(
        ...
        scene_ip_weight=params.get("effective_scene_ip_weight") or params.get("scene_ip_weight"),
        clothing_ip_weight=params.get("effective_outfit_ip_weight") or params.get("clothing_ip_weight"),
